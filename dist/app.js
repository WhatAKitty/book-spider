...
var _koaBunyanLogger = require('koa-bunyan-logger');var _koaBunyanLogger2 = _interopRequireDefault(_koaBunyanLogger);
var _koa2SwaggerUi = require('koa2-swagger-ui');var _koa2SwaggerUi2 = _interopRequireDefault(_koa2SwaggerUi);
...
app.
use((0, _koaStatic2.default)('./static', {
...
use(_koaBunyanLogger2.default.requestIdContext()).
use(_koaBunyanLogger2.default.requestLogger()).
use(router.routes()).
use(router.allowedMethods()).
use((0, _koa2SwaggerUi2.default)({
