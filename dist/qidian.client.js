...
var createHeader = function createHeader(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === undefined ? '4.7.0' : _ref$size,
      _ref$width = _ref.width,
      width = _ref$width === undefined ? 750 : _ref$width,
      _ref$height = _ref.height,
      height = _ref$height === undefined ? 1334 : _ref$height,
      _ref$type = _ref.type,
      type = _ref$type === undefined ? 'AppStore' : _ref$type,
      _ref$osversion = _ref.osversion,
      osversion = _ref$osversion === undefined ? '10.30' : _ref$osversion,
      _ref$device = _ref.device,
      device = _ref$device === undefined ? 'iOS/iPhone/iPhone8,1' : _ref$device,
      _ref$token = _ref.token,
      token = _ref$token === undefined ? '1507347832421' : _ref$token;
...
var Qidian = {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return rest.GET(_config.config.urls.recommend, {
                rCount: 4,
                rdm: 1507298003,
                sId: 0
              });
            ...
            case 7:
              ...
              return _context.abrupt('return', { err: data.Message });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              return _context2.abrupt('return', { err: data.Message });
  ...
  bookInfo: function bookInfo() {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
      var bookId, _params$iosDeviceType, iosDeviceType, _ref4, data, err;

      return _regenerator2.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              bookId = params.bookId, _params$iosDeviceType = params.iosDeviceType, iosDeviceType = _params$iosDeviceType === undefined ? 0 : _params$iosDeviceType;
              _context3.next = 3;
              return rest.GET(_config.config.urls.info, {
                BookId: bookId,
            ...
            case 8:
              ...
              return _context3.abrupt('return', { err: data.Message });
  ...
  chapters: function chapters() {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      var bookId, _params$pageIndex2, pageIndex, _ref5, data, err;

      return _regenerator2.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              bookId = params.bookId, _params$pageIndex2 = params.pageIndex, pageIndex = _params$pageIndex2 === undefined ? -1 : _params$pageIndex2;
              _context4.next = 3;
              return rest.GET(_config.config.urls.chapters, {
                bookId: bookId,
                pageIndex: pageIndex,
                requestSource: 0,
                timeStamp: 0
            ...
            case 8:
              ...
              return _context4.abrupt('return', { err: data.Message });

            case 10:
              return _context4.abrupt('return', { data: data.Data });
  ...
  comments: function comments() {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
      var bookId, _params$pageIndex3, pageIndex, _ref6, data, err;

      return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              bookId = params.bookId, _params$pageIndex3 = params.pageIndex, pageIndex = _params$pageIndex3 === undefined ? 1 : _params$pageIndex3;
              _context5.next = 3;
              return rest.GET(_config.config.urls.comments, {
                ReviewType: 112,
                bookId: bookId,
                pageIndex: pageIndex
              }, {
            ...
            case 8:
              ...
              return _context5.abrupt('return', { err: data.Message });
