          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                console.log('[QUEUE] ' + new Date().toLocaleString('zh') + ' task execute failed, will skip this data and start next one', _context.t0);
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return sleep('function' === typeof this[_options].interval ? this[_options].interval() : this[_options].interval);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return sleep(this[_options].interval);
